...
const noticiasData = [
    { id: 1, t: "La Fractura Histórica del Canal de la Compañía (2010)", img: "https://images.unsplash.com/photo-1545048702-79362596cdc9?w=400" },
    { id: 2, t: "El Fallo del Túnel Profundo y la Recurrencia de 2011", img: "https://images.unsplash.com/photo-1584824486509-112e4181ff6b?w=400" },
    { id: 3, t: "La Emergencia Sanitaria en Chalco (Agosto 2024)", img: "https://images.unsplash.com/photo-1510511459019-5dee997dd1db?w=400" },
    { id: 4, t: "El Misterio del 'Agua Rosa' en Nezahualcóyotl (2024)", img: "https://images.unsplash.com/photo-1468413253725-0d5181091126?w=400" },
    { id: 5, t: "Fractura en el Dren Chimalhuacán II (Julio 2024)", img: "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=400" },
    { id: 6, t: "Caos Vial y Rescate en Los Reyes La Paz (Junio 2025)", img: "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=400" },
    { id: 7, t: "Avalancha de Lodo y Basura en San Sebastián (2025)", img: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=400" },
    { id: 8, t: "Taponamiento Crítico en el Colector Ecatepec (2026)", img: "https://images.unsplash.com/photo-1541339907198-e08756edd811?w=400" },
    { id: 9, t: "Anegamientos Obras Trolebús Chalco (2025)", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400" },
    { id: 10, t: "Atlas: Chalco como Foco Rojo Crítico", img: "https://images.unsplash.com/photo-1518005020480-1cd3460bb994?w=400" }
];

const escenasARData = [
    { id: 1, nombre: "Calle Inundada", info: "Simulación de encharcamiento nivel banqueta en zona habitacional de Chimalhuacán.", img: "https://images.unsplash.com/photo-1545048702-79362596cdc9?w=400" },
    { id: 2, nombre: "Desborde Canal", info: "Modelado preventivo del Canal de la Compañía a máxima capacidad de carga.", img: "https://images.unsplash.com/photo-1584824486509-112e4181ff6b?w=400" },
    { id: 3, nombre: "Cárcamo Activo", info: "Visualización de flujo de agua en sistema de bombeo de la zona oriente.", img: "https://images.unsplash.com/photo-1521401830884-6c03c1c87ebb?w=400" },
    { id: 4, nombre: "Riesgo Eléctrico", info: "Identificación de postes y transformadores peligrosos durante inundación.", img: "https://images.unsplash.com/photo-1473186578172-c141e6798ee4?w=400" },
    { id: 5, nombre: "Ruta de Evacuación", info: "Guía visual 3D sobre el terreno para salir hacia la zona alta del cerro.", img: "https://images.unsplash.com/photo-1510511459019-5dee997dd1db?w=400" }
];
...
async function loadWeather() {
    navigator.geolocation.getCurrentPosition(async (pos) => {
        ...
        try {
            ...
            // PRECIPITACIÓN (3H) CON ICONOS LÓGICOS SEGÚN PETICIÓN
            ...
            document.getElementById('next-3h-text').innerHTML = `${forecastEmoji} <strong>${dataForecast.list[1].weather[0].description.toUpperCase()}</strong><br><small>Probabilidad: ${probRain}% | Volumen: ${rainVol}mm</small>`;
